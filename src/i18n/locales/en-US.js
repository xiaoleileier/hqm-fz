...
export default {
    ...
    auth: {
        ...
        processingOAuth: 'Processing OAuth authorization...',
    ...
    dashboard: {
        ...
        checkinDesc: 'Daily check-in to get random traffic rewards',
        checkinTip: 'Check-in traffic will be reset with the next reset cycle',
        standardCheckin: 'Standard Check-in',
        luckyCheckin: 'Lucky Check-in',
        inputTraffic: 'Input Traffic',
        inputPlaceholder: 'e.g. 100',
        luckyCheckinHint: 'Lucky check-in: May double your traffic or deduct some traffic',
        confirmCheckin: 'Confirm Check-in',
        standardCheckinConfirm: 'Confirm Standard Check-in?',
        standardCheckinDesc: 'Standard check-in will provide you with safe traffic rewards with no risk.',
        checkinOnceWarning: 'Note: You can only check in once per day. After choosing one option, you cannot use the other.',
        alreadyCheckedIn: 'Already checked in today, please come back tomorrow',
