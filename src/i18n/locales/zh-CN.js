...
export default {
    ...
    auth: {
        ...
        googleRegisterSuccess: 'Google 注册成功',
        googleRegisterTimeout: 'Google 注册超时，请重试',
        processingOAuth: '正在处理OAuth授权...',
        pleaseWait: '请稍候，正在完成登录流程',
    ...
    dashboard: {
        ...
        checkin: '每日签到',
        checkinDesc: '每日签到可获得随机流量奖励',
        checkinTip: '签到获得的流量会随着下个重置周期重置',
        standardCheckin: '普通签到',
        luckyCheckin: '运气签到',
        inputTraffic: '输入流量',
        inputPlaceholder: '例如：100',
        luckyCheckinHint: '运气签到：可能获得双倍流量，也可能扣除部分流量,主打一个看脸',
        confirmCheckin: '确认签到',
        standardCheckinConfirm: '确认普通签到？',
        standardCheckinDesc: '普通签到将为您提供安全的流量奖励，不会有任何风险。',
        checkinOnceWarning: '注意：今日只能签到一次，选择后将无法进行其他签到。',
